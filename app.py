...
# App UI
def main():
    st.set_page_config(page_title="SpamSheild-Ai", layout="wide", page_icon="🛡️")
    ...
    st.title("🛡️ SpamShield - AI Email Classifier")
    st.markdown("""
    **AI-powered SpamShield-Ai detection with comprehensive analytics and real-time protection.**
    ...
    st.markdown("""
    <div class="footer">
        <p>Developed with ❤️ by diksha kashyap
                 | SpamShield_AI Pro v2.1 | © 2025 All rights reserved</p>
    </div>
    """, unsafe_allow_html=True)
